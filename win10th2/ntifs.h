...
//  on an intermediate directory (not the final path component):
//
//    OPEN_REPARSE_POINT_REPARSE_IF_CHILD_EXISTS -
//    If the next path component after the directory reparse point exists,
//    reparse on the directory.
//
//    OPEN_REPARSE_POINT_REPARSE_IF_CHILD_NOT_EXISTS -
//    If the next path component after the directory reparse point does not
//    exist, reparse on the directory.
//
//  Specifying both of the above flags is legal and simply means reparse on
//  any intermediate directory reparse points.
//
